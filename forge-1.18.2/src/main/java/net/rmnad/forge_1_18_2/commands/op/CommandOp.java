                            ...
                            for(GameProfile gameProfile : players) {
                                ...
                                if(!playerList.isOp(gameProfile)) {
                                    ...
                                    if(WhitelistSync2.whitelistService.addOppedPlayer(gameProfile.getId(), gameProfile.getName())) {
                                        ...
                                        context.getSource().sendSuccess(new TextComponent(CommandMessages.AddedToOpList(playerName)), true);
                                        ++i;
                                    ...
                                    context.getSource().sendSuccess(new TextComponent(CommandMessages.AlreadyInOpList(playerName)), true);
                                }
                            }
